<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestion_tipo_empleado.aspx.cs" MasterPageFile="~/Site.Master" Inherits="Control_Asistencia_Webform.gestion_tipo_empleado" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
     ...
     <h2>
      <body>
  <p style="color:white";> <strong>Gestión de Tipo de Empleado (Modificar-Eliminar)</strong></p>
</body>
