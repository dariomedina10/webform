...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
 ...
 <div class="form-group">
     <center>
         ...
         <asp:Button ID="Button1" runat="server" Text="Modificar" Width="97px" OnClick="Button2_Click" /> 
         <asp:Button ID="Button3" runat="server" Text="Eliminar" Width="97px" OnClick="Button2_Click" /> 
