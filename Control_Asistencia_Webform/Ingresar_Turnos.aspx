<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ingresar_Turnos.aspx.cs" MasterPageFile="~/Site.Master" Inherits="Control_Asistencia_Webform.Ingresar_Turnos" %>
...
<p>
    ...
    <p>
        &nbsp;<table border="5" cellspacing="2" 
            ...
            <tr>
                <td style="WIDTH: 25%">
                   <strong>Código de Turnos</strong> </td>
                <td style="WIDTH: 50%">
