<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestion_departamentos.aspx.cs" MasterPageFile="~/Site.Master" Inherits="Control_Asistencia_Webform.gestion_departamentos" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
     ...
     <h2>
      <body>
  <p style="color:white";> <strong>Gestión de Departamentos (Modificar-Eliminar)</strong></p>
</body>
