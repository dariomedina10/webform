<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consulta_Departamentos.aspx.cs" MasterPageFile="~/Site.Master" Inherits="Control_Asistencia_Webform.Consulta_Departamentos" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
     ...
     <h2>
      <body>
  <p style="color:white";> <strong>Consulta Por Departamentos</strong></p>
</body>
