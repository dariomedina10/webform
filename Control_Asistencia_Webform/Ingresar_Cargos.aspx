<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ingresar_Cargos.aspx.cs" MasterPageFile="~/Site.Master" Inherits="Control_Asistencia_Webform.Ingresar_Cargos" %>
...
<p>
    ...
    <p>
        &nbsp;<table border="5" cellspacing="2" 
            ...
            <tr>
                <td style="WIDTH: 25%">
                   <strong>Código de Cargo</strong> </td>
                <td style="WIDTH: 50%">
                    <asp:TextBox ID="codigo" runat="server" Enabled="False" Width="300px" OnTextChanged="codigo_TextChanged"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="WIDTH: 25%">
